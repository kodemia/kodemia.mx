...
import Content from '../../components/pages/cursos/py-live/content.md'
import Description from '../../components/pages/cursos/py-live/description.md'
import Testimonial from '../../components/pages/cursos/py-live/testimonial.md'
import Syllabus from '../../components/pages/cursos/py-live/syllabus.md'
import Location from '../../components/pages/cursos/py-live/location.md'
import Pricing from '../../components/pages/cursos/py-live/pricing.md'
import Benefits from '../../components/pages/cursos/py-live/benefits.md'
      ...
      <Layout title="Bootcamp White Koder (Full Stack Jr) :: Kodemia">
        <HeaderCourse white>
          <h1 className="title x:fs-22 s:fs-30 l:fs-40 c-black fw-semi-bold">
            Bootcamp Full Stack Python (Live)
          </h1>
          <p className="desc x:fs-14 s:fs-18 l:fs-20 x:mrg-top-20 c-pink">
            Iníciate en el mundo de la programación como Full Stack
          </p>
          <div className="s:mrg-top-40">
            <a
              href={asset('docs/courses/bootcamps/PYTHON_LIVE-DESKTOP.pdf')}
            ...
            <a
              href={asset('docs/courses/bootcamps/PYTHON_LIVE-MOBILE.pdf')}
        ...
        <section className="x:pad-bt-20 s:pad-bt-40 bg-grey-50 c-black">
          <div className="scontainer">
            <div className="x:mrg-bottom-20">
              <h2 className="c-black">
                Financiamient<Cursor black>o</Cursor>
              </h2>
            </div>
            <Pricing />
          </div>
