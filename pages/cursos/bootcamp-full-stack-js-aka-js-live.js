...
import Content from '../../components/pages/cursos/js-live/content.md'
import Description from '../../components/pages/cursos/js-live/description.md'
import Testimonial from '../../components/pages/cursos/js-live/testimonial.md'
import Syllabus from '../../components/pages/cursos/js-live/syllabus.md'
import Location from '../../components/pages/cursos/js-live/location.md'
import Pricing from '../../components/pages/cursos/js-live/pricing.md'
import Benefits from '../../components/pages/cursos/js-live/benefits.md'
      ...
      <Layout title="Bootcamp White Koder (Full Stack Jr) :: Kodemia">
        <HeaderCourse white>
          <h1 className="title x:fs-22 s:fs-30 l:fs-40 c-black fw-semi-bold">
            Bootcamp Full Stack Javascript (Live)
          </h1>
          ...
          <div className="s:mrg-top-40">
            ...
            <Link href="/aplicar?course=js-live">
