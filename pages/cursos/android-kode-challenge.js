...
import Vacancy from '../../components/pages/cursos/android-kode-challenge/Vacancy'
import Challenge from '../../components/pages/cursos/android-kode-challenge/Challenge'

const EconducePage = () => (
  <Layout title="#HackTheJob | Android Kode Challenge">
    <HeaderCourse
      title="#HackTheJob | Android Kode Challenge"
    ...
    >
      <h1 className="c-white">
        #HackTheJob | Android Kode Challeng<Cursor white>e</Cursor>
      </h1>
    </HeaderCourse>
    <Vacancy />
    <Challenge />
